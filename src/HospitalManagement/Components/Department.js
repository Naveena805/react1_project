  ...
  //                   disabled={nlistdep1.some((item) => item.id === input.id)||nlistdep.some((item) => item.id === input.id) || input.id === ''}
  //                 >
  //                   New
  //                 </Button>
  //               </td>
  ...
  //                   <br />
  //                   {/* index={index}; */}
  //                   <Link to={`/Depdetails?index=${index1}&namedep=${value.name}`}>
  //                   <Button
  //                     type='button'
  ...
  //                   </Button>
  //                   <br/><br/>
  //                   <Link to={`/Depdetails?name=${value.name}&image=${value.pimage}&year=${value.year}&des=${value.des}`}>
  //                   <Button
  //                     type='button'
  //                     className='btn btn-dark'
  //                     style={{
